    ...
    <form id="enemyForm" class="gf-form" autocomplete="off">
      <div class="gf-group">
        ...
        <div class="gf-group__grid">
          ...
          <label class="gf-form__field">
            <span>Speed</span>
            <input id="enemySpeed" name="speed" type="number" step="0.01" required />
            <small class="gf-help">Movement speed per frame.</small>
          </label>
          <label class="gf-form__field">
            <span>Size</span>
            <input id="enemySize" name="size" type="number" step="0.01" required />
            <small class="gf-help">Collision radius; larger is easier to hit.</small>
          </label>
          <label class="gf-form__field">
            <span>Hitbox Size</span>
            <input id="enemyHitboxSize" name="hitboxSize" type="number" step="0.01" />
            <small class="gf-help">Optional radial hitbox; defaults to Size if empty.</small>
          </label>
          <label class="gf-form__field">
            <span>Points</span>
            <input id="enemyPoints" name="points" type="number" step="0.01" required />
            <small class="gf-help">Score awarded for destroying this enemy.</small>
          </label>
          <label class="gf-form__field">
            <span>Shoot Interval (frames)</span>
            <input id="enemyShootInterval" name="shootInterval" type="number" step="0.01" required />
            <small class="gf-help">Lower = shoots more often (frame-based).</small>
          </label>
          <label class="gf-form__field">
            <span>Projectile Damage</span>
            <input id="enemyProjectileDamage" name="projectileDamage" type="number" step="0.01" required />
            <small class="gf-help">Damage dealt by enemy bullets.</small>
          </label>
          <label class="gf-form__field">
            <span>Collision Damage</span>
            <input id="enemyCollisionDamage" name="collisionDamage" type="number" step="0.01" required />
