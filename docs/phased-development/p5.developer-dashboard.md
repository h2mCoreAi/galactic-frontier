...
- [ ] Define JSON Schema for config.json with semantic version (config.version)
- [ ] Implement schema validation in dashboard before save/deploy
- [ ] Add migration scripts to upgrade older configs to latest schema
